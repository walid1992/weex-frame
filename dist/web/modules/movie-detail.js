...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/Guolei/Desktop/develop/weex/weex-frame/src/modules/movie-detail.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] movie-detail.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-4e2ba671", Component.options)
	  } else {
	    hotAPI.reload("data-v-4e2ba671", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(10)("e23c9242", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4e2ba671&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./movie-detail.vue", function() {
	     var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4e2ba671&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./movie-detail.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.slider[data-v-4e2ba671] {\n  width: 750px;\n  height: 440px;\n}\n.video[data-v-4e2ba671] {\n  width: 750px;\n  height: 460px;\n}\n.indicator[data-v-4e2ba671] {\n  position: absolute;\n  width: 690px;\n  height: 20px;\n  top: 400px;\n  left: 240px;\n  itemColor: #dddddd;\n  itemSelectedColor: rgb(40, 96, 144);\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_c('text', [_vm._v(_vm._s(_vm.info))])]), _vm._v(" "), _c('wxc-panel', {
	    attrs: {
	      "title": "剧情",
	      "type": "primary"
	    }
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-4e2ba671", module.exports)
	  }
	}
