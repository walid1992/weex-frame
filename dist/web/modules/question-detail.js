...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/Guolei/Desktop/develop/weex/weex-frame/src/modules/question-detail.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] question-detail.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-89590cf6", Component.options)
	  } else {
	    hotAPI.reload("data-v-89590cf6", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(10)("2efa4b77", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-89590cf6&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./question-detail.vue", function() {
	     var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-89590cf6&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./question-detail.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.scroll[data-v-89590cf6] {\n  /*padding-left: 30px;*/\n  /*padding-right: 30px;*/\n}\n.scroll-content[data-v-89590cf6] {\n  padding-left: 30px;\n  padding-right: 30px;\n}\n.separate-line[data-v-89590cf6] {\n  background-color: #d4d4d4;\n  height: 1px;\n  margin-top: 30px;\n  margin-bottom: 20px;\n}\n.text-title[data-v-89590cf6] {\n  color: black;\n  font-size: 40px;\n  margin-top: 26px;\n  font-weight: bold;\n}\n.text-content[data-v-89590cf6] {\n  color: #333;\n  margin-top: 28px;\n}\n\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v(_vm._s(_vm.questionTitle))]), _vm._v(" "), _c('text', {
	    staticClass: "text-content"
	  }, [_vm._v(_vm._s(_vm.questionTitle))]), _vm._v(" "), _c('div', {
	    staticClass: "separate-line"
	  }), _vm._v(" "), _c('text', {
	    staticClass: "text-title"
	  }, [_vm._v(_vm._s(_vm.answerTitle))]), _vm._v(" "), _c('text', {
	    staticClass: "text-content"
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-89590cf6", module.exports)
	  }
	}
