...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/Guolei/Desktop/develop/weex/weex-frame/src/modules/serial-detail.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] serial-detail.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-8bdf9812", Component.options)
	  } else {
	    hotAPI.reload("data-v-8bdf9812", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(10)("609886fe", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8bdf9812&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./serial-detail.vue", function() {
	     var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8bdf9812&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./serial-detail.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.scroll[data-v-8bdf9812] {\n  /*padding-left: 30px;*/\n  /*padding-right: 30px;*/\n}\n.scroll-content[data-v-8bdf9812] {\n  padding-left: 30px;\n  padding-right: 30px;\n}\n.author-image[data-v-8bdf9812] {\n  height: 100px;\n  width: 100px;\n  border-radius: 50px;\n  background-color: #fff;\n  border-color: #ffffff;\n}\n.text-lead[data-v-8bdf9812] {\n  margin-top: 20px;\n  color: #a5a5a5;\n  font-size: 30px;\n}\n.text-title[data-v-8bdf9812] {\n  color: black;\n  font-size: 40px;\n  margin-top: 26px;\n  font-weight: bold;\n}\n.text-author[data-v-8bdf9812] {\n  color: black;\n  font-size: 26px;\n  height: 50px;\n  text-align: center;\n}\n.text-content[data-v-8bdf9812] {\n  color: #333;\n  margin-top: 28px;\n}\n\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-8bdf9812", module.exports)
	  }
	}
