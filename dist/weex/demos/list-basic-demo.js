...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/Guolei/Desktop/develop/weex/weex-frame/src/demos/list-basic-demo.vue"
...
/***/ function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [((_vm.refreshDisplay === 'hide')) ? _c('text', [_vm._v("↓ pull to refresh")]) : _vm._e(), _c('loading-indicator', {
	    staticClass: ["indicator"]
	  })], 1), _vm._l((_vm.rows), function(i, row) {
	    return _c('cell', {
	      staticClass: ["row"],
	      appendAsTree: true,
	      attrs: {
	  ...
	  }, [((_vm.loadingDisplay === 'hide')) ? _c('text', [_vm._v("↑ Loadmore")]) : _vm._e(), _c('loading-indicator', {
	    staticClass: ["indicator"]
	  })], 1)], 2), _c('text', {
	    staticClass: ["count"]
	  }, [_vm._v("Appear items:" + _vm._s(_vm.appearMin) + " - " + _vm._s(_vm.appearMax))])])
	},staticRenderFns: []}
