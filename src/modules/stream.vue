...
<script>
  ...
  module.exports = {
    ...
    created: function () {
      let me = this
      let GET_URL_JSONP = 'http://jsfiddle.net/echo/jsonp/?callback=anything&result=content_in_response'
      let GET_URL = 'http://httpbin.org/get'
      let POST_URL = 'http://httpbin.org/post'
      let PUT_URL = 'http://httpbin.org/put'
      let DELETE_URL = 'http://httpbin.org/delete'
      let HEAD_URL = 'http://httpbin.org/status/418'
      let PATCH_URL = 'http://httpbin.org/patch'
