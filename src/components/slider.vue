    ...
    <panel title="auto-play" type="primary">
      <panel title="auto-play = false" padding-body="0">
        <slider class="slider" append="tree"
          ...
          <slider-page v-for="(item ,index) in sliders[1].sliderPages" :items="item.items" :key="index"></slider-page>
        </slider>
      </panel>
      <panel title="auto-play = true" padding-body="0">
        <slider class="slider" append="tree"
          ...
          <indicator class="indicator"></indicator>
          <slider-page v-for="(item ,index) in sliders[0].sliderPages" :items="item.items" :key="index"></slider-page>
        </slider>
      </panel>
    </panel>
    ...
    <panel title="Indicator" type="primary">
      ...
      <panel title="itemColor & itemSelectedColor" padding-body="0">
        <slider class="slider" append="tree"
          ...
          <slider-page v-for="(item ,index) in sliders[2].sliderPages" :items="item.items" :key="index"></slider-page>
        </slider>
      </panel>
...
<script>
  let img0 = '//gw.alicdn.com/tps/i2/TB1DpsmMpXXXXabaXXX20ySQVXX-512-512.png_400x400.jpg'
  let img1 = '//gw.alicdn.com/tps/i1/TB1M3sQMpXXXXakXXXXApNeJVXX-360-360.png'
  ...
  export default {
    ...
    methods: {
      togglePlay () {
        let autoPlay = this.sliders[0].autoPlay
        autoPlay = !autoPlay
